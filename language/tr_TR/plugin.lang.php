...
$lang['Active'] = 'Aktif';
$lang['2FA is enabled. Please use an API Key'] = 'İki faktörlü kimlik doğrulama (2FA) etkinleştirildi. Lütfen bir API anahtarı kullanın.';
$lang['Learn more'] = 'Daha fazla öğren';
$lang['Reset 2FA setup'] = '2FA ayarlarını sıfırla';
$lang['See the documentation page &rarr;'] = 'Belgelenme sayfasına bakın &rarr;';
$lang['TF-Help-Description'] = 'İki faktörlü kimlik doğrulama (2FA) etkinleştirildiğinde, Piwigo\'ya bağlanan üçüncü taraf uygulamalar artık yalnızca kullanıcı adınız ve şifrenizle bağlanamayacak. API anahtarı tabanlı bir kimlik doğrulama mekanizması uygulayana veya doğrudan 2FA\'yı entegre edene kadar, Piwigo bu uygulamaların güncellenmeye gerek kalmadan çalışmaya devam edebilmesi için bir çözüm sunmuştur. Bizce oldukça zekice, sizce de öyle değil mi?';
$lang['TF-Help-Info'] = 'İki faktörlü kimlik doğrulama (2FA) etkinleştirildiğinde, üçüncü taraf uygulamalar kullanıcı adınız ve şifrenizle kimlik doğrulaması yapamayacaktır. Kimlik doğrulaması için bir API anahtarı kullanmanız gerekecektir. Bu durum mobil uygulamalar, Lightroom dışa aktarma eklentisi ve Piwigo Uzaktan Senkronizasyon için geçerlidir.';
$lang['TF-Help-Step1'] = 'Profilinizde yeni bir API anahtarı oluşturun. Bağlamak istediğiniz uygulamanın adını verin. Örneğin, "Piwigo mobile iOS". API anahtarınızın "gizli" kısmını mutlaka kaydedin, çünkü bir daha asla görüntülenmeyecektir.';
$lang['TF-Help-Step2'] = 'Mobil uygulamanızda, kullanıcı adı yerine, “pkid-...” ile başlayan API anahtarının kimliğini (tanımlayıcısını) belirtin.';
$lang['TF-Help-Step3'] = 'Mobil uygulamanızda parola yerine, anahtarı oluştururken kopyaladığınız API anahtarının gizli kodunu girin.';
$lang['TF-Help-Step4'] = 'Mobil uygulamanın kimlik doğrulama işlemini başarıyla tamamlaması gerekiyor ve bu işlemden sonra API anahtarıyla ilişkilendirilen kullanıcı olarak tanınacaksınız.';
$lang['TF-Help-Step5'] = 'API anahtarının geçerlilik süresi sınırlı olduğundan, düzenli olarak yenilemeniz gerekecektir. Piwigo, API anahtarlarınızdan birinin süresi dolduğunda sizi e-posta ile bilgilendirecektir.';
$lang['The 2FA has been successfully reset.'] = 'İki faktörlü kimlik doğrulama başarıyla sıfırlandı.';
$lang['Third-party application authentication'] = 'Üçüncü taraf uygulama doğrulaması';
$lang['We have prepared a documentation page to help you, with screenshots.'] = 'Size yardımcı olmak için ekran görüntüleriyle birlikte bir dokümantasyon sayfası hazırladık.';