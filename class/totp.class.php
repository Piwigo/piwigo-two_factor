...
require_once(TF_REALPATH . '/class/base32.class.php');
require_once(TF_REALPATH . '/class/phpqrcode.php');
...
class PwgTOTP
{
   ...
   * Generate a Base32 secret for TOTP
   *
   * @param int $lenght Length in bytes (default: 20)
   * @return string Base32-encoded secret
   */
  public static function generateSecret($lenght = 20)
  {
   ...
   */
  public static function generateCode($secret)
  {
    $timestamp = floor(time() / 30); // e.g 58338889 > 30-second intervals since 1970 at the moment T
   ...
   * @return bool
   */
  public static function verifyCode($code, $secret, $check_interval = 1)
  {
